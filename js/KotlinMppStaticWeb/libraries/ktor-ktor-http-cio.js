(function(root, factory) {
  if (typeof define === 'function' && define.amd) 
    define(['exports', 'kotlin', 'ktor-ktor-http', 'kotlinx-io', 'kotlinx-io-kotlinx-coroutines-io', 'kotlinx-coroutines-core'], factory);
  else if (typeof exports === 'object') 
    factory(module.exports, require('kotlin'), require('ktor-ktor-http'), require('kotlinx-io'), require('kotlinx-io-kotlinx-coroutines-io'), require('kotlinx-coroutines-core'));
  else {
    ...
    if (typeof this['kotlinx-io-kotlinx-coroutines-io'] === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-http-cio'. Its dependency 'kotlinx-io-kotlinx-coroutines-io' was not found. Please, check whether 'kotlinx-io-kotlinx-coroutines-io' is loaded prior to 'ktor-ktor-http-cio'.");
    }
    ...
    root['ktor-ktor-http-cio'] = factory(typeof this['ktor-ktor-http-cio'] === 'undefined' ? {} : this['ktor-ktor-http-cio'], kotlin, this['ktor-ktor-http'], this['kotlinx-io'], this['kotlinx-io-kotlinx-coroutines-io'], this['kotlinx-coroutines-core']);
  }
}(this, function(_, Kotlin, $module$ktor_ktor_http, $module$kotlinx_io, $module$kotlinx_io_kotlinx_coroutines_io, $module$kotlinx_coroutines_core) {
  'use strict';
  ...
  var copyTo = $module$kotlinx_io_kotlinx_coroutines_io.kotlinx.coroutines.io.copyTo_lhug7f$;
  var equals = Kotlin.equals;
  var Throwable = Error;
  var close = $module$kotlinx_io_kotlinx_coroutines_io.kotlinx.coroutines.io.close_sypobt$;
  var coroutines = $module$kotlinx_coroutines_core.kotlinx.coroutines;
  var reader = $module$kotlinx_io_kotlinx_coroutines_io.kotlinx.coroutines.io.reader_ymoia9$;
  ...
  function skipSpHTab(text, start, end) {
    var index = start;
    while (index < end) {
      var ch = text.charCodeAt(index);
      if (ch !== 32 && ch !== HTAB) 
  ...
  package$internals.skipSpHTab_cwfmo4$ = skipSpHTab;
