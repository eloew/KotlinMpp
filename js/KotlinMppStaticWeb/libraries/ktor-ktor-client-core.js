(function(root, factory) {
  if (typeof define === 'function' && define.amd) 
    define(['exports', 'kotlin', 'ktor-ktor-utils', 'kotlinx-io', 'kotlinx-coroutines-core', 'kotlinx-io-kotlinx-coroutines-io', 'ktor-ktor-http', 'ktor-ktor-http-cio'], factory);
  else if (typeof exports === 'object') 
    factory(module.exports, require('kotlin'), require('ktor-ktor-utils'), require('kotlinx-io'), require('kotlinx-coroutines-core'), require('kotlinx-io-kotlinx-coroutines-io'), require('ktor-ktor-http'), require('ktor-ktor-http-cio'));
  else {
    ...
    if (typeof this['kotlinx-io-kotlinx-coroutines-io'] === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-client-core'. Its dependency 'kotlinx-io-kotlinx-coroutines-io' was not found. Please, check whether 'kotlinx-io-kotlinx-coroutines-io' is loaded prior to 'ktor-ktor-client-core'.");
    }
    ...
    root['ktor-ktor-client-core'] = factory(typeof this['ktor-ktor-client-core'] === 'undefined' ? {} : this['ktor-ktor-client-core'], kotlin, this['ktor-ktor-utils'], this['kotlinx-io'], this['kotlinx-coroutines-core'], this['kotlinx-io-kotlinx-coroutines-io'], this['ktor-ktor-http'], this['ktor-ktor-http-cio']);
  }
}(this, function(_, Kotlin, $module$ktor_ktor_utils, $module$kotlinx_io, $module$kotlinx_coroutines_core, $module$kotlinx_io_kotlinx_coroutines_io, $module$ktor_ktor_http, $module$ktor_ktor_http_cio) {
  'use strict';
  ...
  var ByteReadChannel = $module$kotlinx_io_kotlinx_coroutines_io.kotlinx.coroutines.io.ByteReadChannel;
  ...
  var ByteReadChannel_0 = $module$kotlinx_io_kotlinx_coroutines_io.kotlinx.coroutines.io.ByteReadChannel_mj6st8$;
  ...
  var joinTo = $module$kotlinx_io_kotlinx_coroutines_io.kotlinx.coroutines.io.joinTo_ulwomx$;
  ...
  var writer = $module$kotlinx_io_kotlinx_coroutines_io.kotlinx.coroutines.io.writer_r5ogg1$;
  ...
  var readRemaining_0 = $module$kotlinx_io_kotlinx_coroutines_io.kotlinx.coroutines.io.readRemaining_5joj65$;
  ...
  var copyAndClose = $module$kotlinx_io_kotlinx_coroutines_io.kotlinx.coroutines.io.copyAndClose_lhug7f$;
  ...
  var writeFully = $module$kotlinx_io_kotlinx_coroutines_io.kotlinx.coroutines.io.writeFully_p8yv3v$;
  ...
  var cancel_0 = $module$kotlinx_io_kotlinx_coroutines_io.kotlinx.coroutines.io.cancel_ep79e2$;
  var readFully = $module$kotlinx_io_kotlinx_coroutines_io.kotlinx.coroutines.io.readFully_5l0546$;
  ...
  function JsClientEngine(config) {
    ...
    this.coroutineContext_ynwhqr$_0 = this.dispatcher.plus_1fupul$(SilentSupervisor());
  }
