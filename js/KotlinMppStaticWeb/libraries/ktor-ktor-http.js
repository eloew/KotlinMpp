(function(root, factory) {
  if (typeof define === 'function' && define.amd) 
    define(['exports', 'kotlin', 'kotlinx-io', 'ktor-ktor-utils', 'kotlinx-io-kotlinx-coroutines-io', 'kotlinx-coroutines-core'], factory);
  else if (typeof exports === 'object') 
    factory(module.exports, require('kotlin'), require('kotlinx-io'), require('ktor-ktor-utils'), require('kotlinx-io-kotlinx-coroutines-io'), require('kotlinx-coroutines-core'));
  else {
    ...
    if (typeof this['kotlinx-io-kotlinx-coroutines-io'] === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-http'. Its dependency 'kotlinx-io-kotlinx-coroutines-io' was not found. Please, check whether 'kotlinx-io-kotlinx-coroutines-io' is loaded prior to 'ktor-ktor-http'.");
    }
    ...
    root['ktor-ktor-http'] = factory(typeof this['ktor-ktor-http'] === 'undefined' ? {} : this['ktor-ktor-http'], kotlin, this['kotlinx-io'], this['ktor-ktor-utils'], this['kotlinx-io-kotlinx-coroutines-io'], this['kotlinx-coroutines-core']);
  }
}(this, function(_, Kotlin, $module$kotlinx_io, $module$ktor_ktor_utils, $module$kotlinx_io_kotlinx_coroutines_io, $module$kotlinx_coroutines_core) {
  'use strict';
  ...
  while (tmp$.hasNext()) {
    ...
    if (unboxChar(ch) <= 32 || isDelimiter(unboxChar(ch))) {
